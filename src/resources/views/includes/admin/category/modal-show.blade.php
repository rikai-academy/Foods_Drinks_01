<!-- Modal show-->
<div class="modal fade" id="modalShowCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="" method="post" id="form_show">
                ...
                <div class="modal-body">
                    <p>{{__('custom.Are you sure you want to show this category')}}</p>
