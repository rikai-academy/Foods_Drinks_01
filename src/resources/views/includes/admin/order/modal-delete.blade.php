<!-- Modal delete-->
<div class="modal fade" id="modalDeleteOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>{{__('custom.Are you sure you want to remove the order')}}</p>
            </div>
