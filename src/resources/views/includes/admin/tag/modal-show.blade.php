<!-- Modal show-->
<div class="modal fade" id="modalShowTag" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="post" id="form_show_tag">
                @csrf
                ...
                <div class="modal-body">
                    <p>{{__('custom.Are you sure you want to show this tag')}}</p>
